...
CATEGORIES = [
    ...
    {"id": 2, "name": "Домашний телефон",
        "items": [
            "Копытова Елизавета", "Новикова  Светлана", "Кологривов Захар"
        ], "color": "#2ecc71"},
...
ESPORTS = {
    ...
    "results": {
        0: [
            {"player": "Лешко Виктория", "score": "1:30"},
        ...
        3: [
            {"player": "Давыденко Данил", "score": 2300},
            {"player": "Яськов Михаил", "score": 1950},
            {"player": "Мирошников Александр", "score": 1950}
