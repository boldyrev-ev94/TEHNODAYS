...
LEADERS = [
    ...
    {"rank": 4,
     ...
     "category": "Решетников Артур ",
     "score":  "",
     "user_name": ""},
    {"rank": 5,
     "name": "Старый комп VS Новый",
     "category": "Андреева Анна ",
     "score":  "",
     "user_name": ""},
    {"rank": 6,
    ...
    {"rank": 9,
     "name": "За рулём",
     "category": "Иванов Михаил ",
     "score":  "",
     "user_name": ""},
    {"rank": 10,
     "name": "НТО",
        "category": "Бойков Артём",
        "score": "",
        "user_name": ""},
]
...
ESPORTS = {
    ...
    "results": {
        0: [
            {"name": "Гонки", "player": "Михайлов Алексей", "score": "1:30"},
            {"name": "Гонки", "player": "Дорофеева София", "score": "1:35"},
            {"name": "Гонки", "player": "Балашев Александр ", "score": "2:05"},
        ],
        1: [
            {"name": "Пакман", "player": "Лованкова Юлия", "score": 2750},
            {"name": "Пакман", "player": "Копытова Елизавета ", "score": 1470},
        ...
        3: [
            {"name": "Тетрис", "player": "Скулов Никита", "score": 104638},
            {"name": "Тетрис", "player": "Саттаров Эмиль", "score": 12879},
            {"name": "Тетрис", "player": "Отто Екатерина", "score": 11071},
