...
LEADERS = [
    ...
    {"rank": 3,
     ...
     "category": "Дауленбаева Алина ",
     "score":  "",
     "user_name": ""},
    {"rank": 4,
     "name": "Словарь без инета",
     "category": "Пивоварова Мария",
     "score":  "",
     "user_name": ""},
    {"rank": 5,
     "name": "Старый комп VS Новый",
     "category":  "Бнснев Дима",
     "score":  "",
     "user_name": ""},
    {"rank": 6,
     "name": "Железный конструктор",
     "category": "Фоменко Дима",
     "score":  "",
     "user_name": ""},
    {"rank": 7,
...
ESPORTS = {
    ...
    "results": {
        ...
        2: [
            {"name": "Fruit ninja", "player": "Кушнир Александр ", "score": 1400},
            {"name": "Fruit ninja", "player": "Флоленко Паша", "score": 1056},
            {"name": "Fruit ninja", "player": "Флоленко Денис", "score": 972}
        ],
        3: [
            {"name": "Тетрис", "player": "Кушнир Александр ", "score": 6720},
            {"name": "Тетрис", "player": "Флоленко Паша", "score": 6224},
            {"name": "Тетрис", "player": "Флоленко Денис", "score": 6088},
        ],
    }
}
